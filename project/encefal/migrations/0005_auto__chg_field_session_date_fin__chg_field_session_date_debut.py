...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.date_fin'
        db.alter_column(u'encefal_session', 'date_fin', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Session.date_debut'
        db.alter_column(u'encefal_session', 'date_debut', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Session.date_fin'
        db.alter_column(u'encefal_session', 'date_fin', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Session.date_debut'
        db.alter_column(u'encefal_session', 'date_debut', self.gf('django.db.models.fields.DateField')(default=None))
