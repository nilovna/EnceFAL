...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Livre', fields ['isbn']
        db.create_unique(u'encefal_livre', ['isbn'])


    def backwards(self, orm):
        # Removing unique constraint on 'Livre', fields ['isbn']
        db.delete_unique(u'encefal_livre', ['isbn'])
